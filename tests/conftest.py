...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "rdkit: tests that require RDKit to be installed")
    config.addinivalue_line("markers", "mongodb: tests that require MongoDB connection")
    config.addinivalue_line("markers", "integration: integration tests requiring all dependencies")
